...
from settings import experiment_run, base_architecture, num_classes

def construct_PPNet(base_architecture, pretrained=False, img_size=224,
                    prototype_shape=None,
                    num_classes=num_classes, topk_k=1, m=None,
    ...
    assert prototype_shape is not None, "prototype_shape must be specified"
    print(f"Prototype Shape Being Passed to Model: {prototype_shape}")
